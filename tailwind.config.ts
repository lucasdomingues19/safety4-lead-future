	...
	theme: {
		...
		extend: {
			...
			fontFamily: {
				...
				'futura': ['"Plus Jakarta Sans"', 'system-ui', 'sans-serif'],
			...
			keyframes: {
				...
				'grid-glow': {
					'0%': {
						background: 'radial-gradient(circle 380px at 15% 30%, rgba(52,52,255,0.16), transparent 70%)'
					},
					'50%': {
						background: 'radial-gradient(circle 480px at 55% 60%, rgba(52,52,255,0.14), transparent 70%)'
					},
					'100%': {
						background: 'radial-gradient(circle 380px at 15% 30%, rgba(52,52,255,0.16), transparent 70%)'
					}
