            ...
            <div className="grid lg:grid-cols-[1fr_auto] gap-12 lg:gap-16 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <div className="flex items-center justify-center lg:justify-start gap-2 md:gap-4 mb-6 md:mb-8 flex-wrap">
                  ...
                  <div className="inline-flex items-center space-x-1 md:space-x-2 text-lime-400 font-medium bg-lime-400/10 px-3 md:px-6 py-2 md:py-3 rounded-full border border-lime-400/20 text-sm md:text-base">
