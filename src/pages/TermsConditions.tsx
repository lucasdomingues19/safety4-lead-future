      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-2xl p-8 md:p-12 border border-slate-200 shadow-sm">
          ...
          <div className="space-y-6 text-slate-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">3. Account Registration and Eligibility</h2>
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">3.1 Eligibility</h3>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">3.2 Account Creation</h3>
              <p>You agree to:</p>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">3.3 Account Restrictions</h3>
              <p>You may not:</p>
              <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">4. Course Enrollment and Access</h2>
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">4.1 Course Purchase</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">4.2 Access Duration</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">4.3 Platform Availability</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">5. Payment and Pricing</h2>
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">5.1 Pricing</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">5.2 Payment Processing</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">5.3 Taxes</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">6. Refund and Cancellation Policy</h2>
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">6.1 Refund Eligibility</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">6.3 Non-Refundable Items</h3>
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">7.3 Restrictions</h3>
              <p>You may not:</p>
              <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">8. Certification and Accreditation</h2>
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">8.1 Certification Requirements</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">8.2 Certificate Validity</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">8.3 Certificate Revocation</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">9. User Conduct and Prohibited Activities</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">10. Disclaimers and Limitations of Liability</h2>
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">10.1 Educational Purpose</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">10.2 Career Outcomes</h3>
              <p>
            ...
            <section>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">12.1 Termination by You</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">12.2 Termination by Us</h3>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">12.3 Effect of Termination</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">13. Privacy and Data Protection</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">15. Governing Law and Dispute Resolution</h2>
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">15.1 Governing Law</h3>
              <p>
                These Terms are governed by and construed in accordance with the laws of England and Wales, 
                without regard to conflict of law principles.
              </p>

              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">15.2 Dispute Resolution</h3>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-slate-900 mb-4">16. Miscellaneous Provisions</h2>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">16.3 Waiver</h3>
              <p>
              ...
              <h3 className="text-lg font-semibold text-slate-900 mb-2 mt-3">16.4 Assignment</h3>
              <p>
