  ...
  const categories = [
    ...
    },
    {
      ...
      faqs: [
        ...
        { question: "When is the next cohort?", answer: "The next cohort runs 2nd September – 30th September, 2026. Cohorts run monthly — if September fills, you'll be offered a place on the next available one." },
      ],
    },
    {
