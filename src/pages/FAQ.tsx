  ...
  const categories = [
    ...
    },
    {
      ...
      faqs: [
        ...
        { question: "How much does it cost and can my employer pay?", answer: "£1,997 +VAT per person (reduced from £1,497). We support PO/invoice billing for employer-sponsored enrolments. Mention this in your application and we'll handle the paperwork." },
        { question: "When is the next cohort?", answer: "The next cohort runs 2nd June – 30th June, 2026. Cohorts run monthly — if June fills, you'll be offered a place on the next available one." },
      ],
    },
    {
