        ...
        <div className="container mx-auto px-4 max-w-6xl">
          <div className="lg:pr-[40%]">
            ...
            <div className="space-y-4 text-slate-600 text-base leading-relaxed">
              ...
              <p>
                Our next cohort runs from <span className="text-slate-900 font-semibold">2nd September – 14th October, 2026</span>.
              </p>
                ...
                <div>
                  ...
                  <Select value={form.cohort} onValueChange={(v) => handleChange("cohort", v)} required>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="october-2026">October 2026 (waitlisted)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
