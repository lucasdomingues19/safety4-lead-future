...
const Cohort = () => {
  ...
  { weeks: "WK 3", title: "Data strategy, Safetytech applications", desc: "Data strategy for safety functions. Wearables, sensors, computer vision, and drones in practice. Predictive analytics for proactive risk reduction." },
