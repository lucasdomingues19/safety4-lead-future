...
const Syllabus = () => {
  ...
  return (
    <div className="min-h-screen relative">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-3 gap-5 mb-10">
            {[
              ...
              <div key={i} className="group rounded-2xl border border-border bg-card p-6 hover:border-primary/35 transition-colors">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              return (
                <div
                  key={i}
                  className="group relative rounded-2xl border border-white/10 bg-white/[0.03] p-6 hover:bg-white/[0.06] hover:border-primary/30 transition-all duration-500"
                >
                  <div className="flex items-start gap-4">
                    <div className="flex-shrink-0">
                      <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${i % 2 === 0 ? 'bg-primary/15' : 'bg-pink-500/15'} group-hover:scale-110 transition-transform duration-500`}>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              ...
              <div key={i} className="group relative rounded-2xl border border-primary/20 bg-primary/[0.05] p-6 hover:bg-primary/[0.12] hover:border-primary/40 transition-all duration-500">
      ...
      {/* eLearning vs Accelerator Comparison */}
      <section className="py-20 px-4 border-t border-white/10">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-12">
            <span className="inline-block text-[10px] tracking-[3px] text-primary font-bold mb-4">TWO PATHWAYS</span>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Choose the Path That <span className="text-primary">Fits You</span>
            </h2>
            <p className="text-lg text-gray-300 max-w-2xl mx-auto">
              Both pathways deliver the same IOSH-approved content. The difference is how you learn.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-6">
            {/* eLearning Card */}
            <div className="rounded-2xl border-2 border-primary/50 bg-primary/[0.06] p-8 flex flex-col">
              <div className="text-[10px] tracking-[3px] text-primary font-bold mb-2">eLEARNING</div>
              <h3 className="text-2xl font-bold text-white mb-2">Self-Paced</h3>
              <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                Maximum flexibility. Learn on your schedule with lifelong access to all materials. Complete in 30 days after purchase.
              </p>
              <ul className="space-y-3 mb-8 flex-1">
                {["Self-paced, learn anytime", "Lifelong access to materials", "30 days to complete", "60+ video lessons", "IOSH & CPD certification", "Downloadable resources", "Mobile app access"].map((f, i) => (
              ...
              <div className="text-3xl font-black text-white mb-4">£597 <span className="text-sm font-normal text-gray-400">+VAT</span></div>
              <a
                href="https://safetyacademy.mykajabi.com/offers/E2ZXsoXV"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 w-full py-4 bg-primary text-black font-bold text-base rounded-full hover:bg-primary/90 transition-colors active:scale-[0.97]"
              >
                Enrol Now
                <ArrowRight className="w-5 h-5" />
              </a>
            ...
            {/* Accelerator Card */}
            <div className="rounded-2xl border border-pink-500/30 bg-pink-500/[0.06] p-8 flex flex-col">
              <div className="text-[10px] tracking-[3px] text-pink-400 font-bold mb-2">ACCELERATOR · COHORT</div>
              <h3 className="text-2xl font-bold text-white mb-2">Expert-Led</h3>
              <p className="text-gray-400 text-sm mb-6 leading-relaxed">
                Live group sessions, peer networking, and direct access to instructors. A 4-week intensive experience.
              </p>
              <ul className="space-y-3 mb-8 flex-1">
                {["Everything in eLearning", "4-week live cohort programme", "Weekly live sessions", "Peer networking & discussions", "Live Q&A with experts", "Career coaching sessions", "Exclusive community access"].map((f, i) => (
                  <li key={i} className="flex items-start gap-2 text-sm text-gray-300">
              ...
              <div className="text-3xl font-black text-white mb-4">£997 <span className="text-sm font-normal text-gray-400">+VAT per person</span></div>
              <a
                href="/accelerator"
                className="inline-flex items-center justify-center gap-2 w-full py-4 bg-pink-500 text-white font-bold text-base rounded-full hover:bg-pink-600 transition-colors active:scale-[0.97]"
              >
                Learn More
                <ArrowRight className="w-5 h-5" />
              </a>
