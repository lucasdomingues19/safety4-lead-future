    ...
    <section className="py-14 md:py-20 relative overflow-hidden bg-white">
      <div className="mx-auto w-full max-w-6xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 mb-12">
          {/* Left: Copilot Course Card - Link to full course */}
          <a href="/copilot-for-ehs" className="block group">
          ...
          <div className="flex items-center justify-center">
            <div
              className="w-full bg-[#FAFAFA] rounded-lg overflow-hidden cursor-pointer hover:shadow-lg transition-shadow"
